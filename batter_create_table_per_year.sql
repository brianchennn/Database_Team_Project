...
select batter_avg.year,batter_avg.id, batter_avg.first_name,batter_avg.last_name,batter_walk.PA as PA,batter_avg.atbat, batter_avg.atbat 
		as AB, batter_slg._H as "H", batter_slg._1B as "1B", batter_slg._2B as "2B", batter_slg._3B as "3B", batter_slg._HR as "HR",batter_avg.AVG,batter_OBP.OBP,batter_slg.SLG, batter_ops.OPS,batter_babip.BABIP , batter_strikeout.strikeout 
		as K, 
...
where batter_avg.id = batter_slg.id and 
	  ...
	  batter_walk.year = batter_babip.year  and
	  batter_babip.year = batter_IBB.year  
