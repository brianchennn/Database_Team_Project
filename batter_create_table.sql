create table batter_create_table(select batter_avg.year,batter_avg.id, batter_avg.first_name,batter_avg.last_name,batter_walk.PA as PA,batter_avg.atbat as AB, batter_slg._1B as "1B", batter_slg._2B as "2B", batter_slg._3B as "3B", batter_slg._HR as "HR",batter_obp.OBP, batter_ops.OPS, batter_strikeout.strikeout as K, batter_strikeout.strikeout_rate*9 as K9,
